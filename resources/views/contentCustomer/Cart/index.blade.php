    ...
    <div class="row" style="margin-top: 100px;">
        <div class="col-md-8">
                    ...
                    <td class="align-middle">
                        <div class="d-flex align-items-center">
                            <form action="{{ url('cart.add') }}" method="POST" class="d-inline-block">
                                @csrf
                                <input type="hidden" name="id_cart" value="{{ $cartItem->id }}">
                                <input type="text" name="quantity" value="{{ $cartItem->quantity }}">
                                <button type="submit" class="btn btn-sm btn-primary">Update</button>
                            </form>
                        </div>
                    </td>
                    <td class="text-end">Rp {{ number_format($cartItem->produk->harga * $cartItem->quantity, 0, ',', '.') }}</td>
                </tr>
                @endforeach
                </tbody>
            </table>
            ...
            <div class="d-flex justify-content-end">
                ...
                <p class="h5 ms-2">Rp 2.375.000</p>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between border-bottom">
                        ...
                        <p><strong>Rp 2.425.000</strong></p>
                    </div>
                </div>
                <div class="mt-4 text-center">
                    <a href="#" class="btn btn-primary btn-block" style="margin-bottom: 10px; margin-left: 55px; background-color: #FCC0C0; color: black; width: 250px;">Continue to Payment</a>
                </div>
            </div>
        </div>
    </div>
