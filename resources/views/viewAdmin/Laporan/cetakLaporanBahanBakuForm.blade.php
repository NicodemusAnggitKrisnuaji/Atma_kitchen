                    ...
                    <div class="card-body">
                        <form class="form-inline">
                            ...
                            <div class="form-group mb-3">
                                <a href="" onclick="this.href='/laporanBahanBaku/cetakLaporanBahanBakuTabel/' + document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value" target="_blank" class="btn btn-primary">
