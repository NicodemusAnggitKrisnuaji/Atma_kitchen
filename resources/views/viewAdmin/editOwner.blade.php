...
<div class="container center-container">
    <div class="col-md-5 login-box" style="margin-top: 100px; margin-bottom: 50px;">
        ...
        <form action="{{ route('updateProfileOwner', ['id' => $user->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <a href="{{ route('profileOwner') }}" class="btn btn-primary btn-block" style="width: 40%; background-color: red; color: black; margin-left: 20px;">Cancel</a>
            </div>
            <br>
        </form>
    </div>
