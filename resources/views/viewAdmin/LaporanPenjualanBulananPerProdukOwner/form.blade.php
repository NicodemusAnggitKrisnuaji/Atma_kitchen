...
<div class="report-container">
    ...
    <div class="report-details">
        <p><strong>LAPORAN PENJUALAN BULANAN OWNER</strong></p>
    ...
    <div class="report-footer">
        <a href="{{ route('laporan.generate-pdf', ['bulan' => $month, 'tahun' => $year]) }}" class="btn btn-primary" target="_blank">Cetak PDF</a>
    </div>
</div>
